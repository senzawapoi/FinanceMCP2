...
import {
  formatBasicCashFlow,
  formatOperatingCashFlow,
  formatInvestingCashFlow,
  formatFinancingCashFlow,
  formatCashflowSupplement,
  formatSpecialCashFlow,
  formatCashflowAll
...
export const cashFlow = {
  ...
  async handler(args: any) {
    try {
      ...
      // 参数映射到原始API参数
      const apiDataTypeMap: Record<string, string> = {
