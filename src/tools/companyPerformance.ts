...
export const companyPerformance = {
  ...
  description: "获取上市公司综合表现数据，包括业绩预告、业绩快报、财务指标、分红送股、主营业务构成、股东变动数据、管理层信息、资产负债表、现金流量表、利润表等完整财务报表数据",
  parameters: {
    type: "object",
    properties: {
      ts_code: {
