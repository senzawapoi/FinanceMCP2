...
// 2. 经营活动现金流详情格式化
export function formatOperatingCashFlow(data) {
    if (!data || data.length === 0)
        return '暂无数据\n\n';
...
// 3. 投资活动现金流详情格式化
export function formatInvestingCashFlow(data) {
    if (!data || data.length === 0)
        return '暂无数据\n\n';
...
// 4. 筹资活动现金流详情格式化
export function formatFinancingCashFlow(data) {
    if (!data || data.length === 0)
        return '暂无数据\n\n';
...
// 5. 现金流补充信息格式化
export function formatCashflowSupplement(data) {
    if (!data || data.length === 0)
        return '暂无数据\n\n';
...
// 6. 特殊业务现金流格式化
export function formatSpecialCashFlow(data) {
    if (!data || data.length === 0)
        return '暂无数据\n\n';
